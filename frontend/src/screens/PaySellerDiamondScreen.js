        ...
        <>
          ...
          <Col md={3}>
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                Description: With this plan you can add 200 products on our platform. Please be sure when you add the products since if you wish to delete or edit the products in case of corrections you will have to contact the admin
              </ListGroup.Item>
            </ListGroup>
          </Col>
